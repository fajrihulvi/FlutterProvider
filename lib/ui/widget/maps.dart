...
class _MapsScreenState extends State<MapsScreen> {
  ...
  void initState() {
    ...
    _currentPosition = LatLng(-2.070556, 106.077080);
  ...
  Future<void> _initLocationService() async {
    ...
    try {
      _currentPosition = LatLng(-2.070556, 106.077080); ///latitude dan longitude di dapat dari database.
  ...
  void _geocodeCurrentPosition() async {
    ...
    print('a >>>>>>>>>>>>>>>>>>>>> $_currentPosition');
    print('a >>>>>>>>>>>>>>>>>>>>> ${_currentPosition.longitude } + " " + ${_currentPosition.latitude} ');
